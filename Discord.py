...
ctypes.windll.kernel32.SetConsoleTitleW('Discord Nickname Changer | Developed by Scobecraft')
...
def ChangeNickname():
    ...
    try:
        ...
        nicknames = ['Scobecraft', 'https://github.com/Scobecraft', 'Hello world!', 'abc', '123']
